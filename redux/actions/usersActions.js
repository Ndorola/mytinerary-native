...
const userActions = {
    ...
    signIn: (addUser) => {
        return async (dispatch) => {
            ...
            try {
                let response = await axios.post("https://nd-mytinerary.herokuapp.com/api/users/signin", { ...addUser })           
    ...
    signUp: (addUser) => {
        ...
        let response = await axios.post("https://nd-mytinerary.herokuapp.com/api/users/signup", { ...addUser });
    ...
    signInLS: (token) => {
        return async (dispatch, getState) => {
        try {
            let response = await axios.get('https://nd-mytinerary.herokuapp.com/api/verifytoken', {
                headers: {
